...
class ImageFolder(DatasetFolder):
    ...
    def __getitem__(self, index):
        ...
        # select pos samples
        pos_image = self.get_pos(index)
        pos_image = self.loader(pos_image)

        add_posq = self.transform(pos_image)
        add_posk = self.transform(pos_image)
    ...
    def get_pos(self, index):
        ...
        pos_sample = self.samples[selected_pos_index]
        pos_image   = pos_sample[0]
